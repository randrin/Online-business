...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			...
			<br>
			<br>
			<a href="${contextRoot}/show/all/products" class="btn btn-primary"><b><i class="material-icons" style="font-size:10px">undo</i></span> Back Shopping</b></a>
			<security:authorize access="hasAuthority('USER')">
				<c:choose>
					...
					<c:otherwise>
						<a href="${contextRoot}/cart/add/${product.id}/product" class="btn btn-success"><b><i class="fa fa-cart-arrow-down"></i> Add to Cart</b></a>
					</c:otherwise>
				</c:choose>
			</security:authorize>
